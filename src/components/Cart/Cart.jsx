            ...
            <Link href={`/products/${product.id}`} className="group block">
                ...
                <div className="relative overflow-hidden rounded-lg bg-gray-100 aspect-[3/4] mb-3">
                    ...
                    <button
                        ...
                        className="absolute top-2 right-2 z-10 w-8 h-8 sm:w-9 sm:h-9 bg-white rounded-full flex items-center justify-center shadow hover:bg-black hover:text-white transition"
                    >
                        <Heart
                            size={16}
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-8 order-1">
                        <div className="flex items-center justify-between mb-4 sm:mb-6">
                            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-sans text-gray-900">Shopping Cart</h1>
                        ...
                        {/* Gift Option */}
                        <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 mb-3 sm:mb-4 border border-gray-200">
                            <label className="flex items-center cursor-pointer group">
                                <input
                                    ...
                                    className="w-4 h-4 text-teal-600 border-gray-300 rounded focus:ring-2 focus:ring-teal-500 focus:ring-offset-0 flex-shrink-0"
                                />
                                <span className="ml-2.5 sm:ml-3 text-xs sm:text-sm font-medium text-gray-700 group-hover:text-gray-900">
                                    This order is a gift
                                </span>
                                <Package className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-1.5 sm:ml-2 text-gray-400 flex-shrink-0" />
                            </label>
                        </div>
                                    ...
                                    <div className="flex gap-3 sm:gap-4 md:gap-6">
                                        ...
                                        <div className="flex-grow flex flex-col min-w-0">
                                            <div className="flex justify-between items-start mb-2 gap-2">
                                                ...
                                                <span className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 flex-shrink-0">
                                                    ${item.price}
                                                </span>
                                            </div>
                    ...
                    <div className="lg:col-span-4 order-2">
                        <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-4 sm:p-5 md:p-6 lg:sticky lg:top-8">
                            <h2 className="text-lg sm:text-xl font-sans text-gray-900 mb-4 sm:mb-6">Order Summary</h2>
                            ...
                            <div className="border-t border-gray-200 pt-3 sm:pt-4 mb-4 sm:mb-6">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-xl sm:text-2xl font-bold text-gray-900">${estimatedTotal.toFixed(2)}</span>
                                </div>
                            ...
                            <Link
                                href="/checkout"
                                className="block w-full bg-black text-white font-semibold py-3 sm:py-3.5 md:py-4 rounded-lg transition-all text-center text-sm sm:text-base shadow-sm hover:shadow-md active:scale-[0.98] touch-manipulation"
                            >
                                Proceed to Checkout
                            </Link>

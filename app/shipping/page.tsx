...
export default function ShippingReturnsPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-gray-900 to-black py-20 sm:py-28 lg:py-36">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-block mb-6 px-5 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
                        <span className="text-sm font-semibold text-blue-300 tracking-wide">DELIVERY & RETURNS</span>
                    </div>

                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-light text-white mb-6 tracking-tight">
                        Shipping &
                        <span className="block mt-2 bg-gradient-to-r from-blue-400 via-emerald-400 to-teal-400 bg-clip-text text-transparent font-normal">
                            Returns Policy
                        </span>
                    </h1>
            ...
            <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="/contact"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-900 rounded-xl font-semibold transition-all duration-300 hover:shadow-2xl hover:scale-105"
                        >
                            Contact Support
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                            href="/faq"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-white/20 rounded-xl font-semibold transition-all duration-300 hover:bg-white/20 hover:scale-105"
                        >
                            View FAQs
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

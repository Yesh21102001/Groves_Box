...
import { getProducts } from "../../../src/lib/shopify_utilis";
...
export default function CartPage() {
    ...
    const increaseQty = (lineId: string, currentQty: number) => {
    ...
    const recommendedProducts = products
        .filter((product: any) => !cartItems.some((cartItem: any) => cartItem.name === product.name))
        .slice(0, 4)
        .map((product: any) => ({
            ...product,
    ...
    // Product Card Component - WORKING VERSION (same as product detail page)
